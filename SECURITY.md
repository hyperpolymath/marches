...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/marches/security/advisories/new)
...
- This repository (`hyperpolymath/marches`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/marches/security/advisories)
...
When using Marches, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/marches/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/marches/security/advisories/new) or j.d.a.jewell@open.ac.uk |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/marches/discussions) |
...
*Thank you for helping keep Marches and its users safe.* 🛡️
